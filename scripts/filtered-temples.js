...
const temples = [
    ...
    {
        templeName: "Guatemala Temple",
        location: "Guatemala City",
        dedicated: "1984, December, 14",
        area: "5067",
        imageUrl: "https://churchofjesuschristtemples.org/assets/img/temples/guatemala-city-guatemala-temple/guatemala-city-guatemala-temple-68580-main.jpg"
    },
    {
    ...
    {
        templeName: "Rio de Janerio Brazil",
        location: "Brazil ",
        dedicated: "2022, May, 14",
        area: "5067",
...
document.querySelector("#old").addEventListener("click", () => {
    document.querySelector(".res-grid").replaceChildren();
